function userLength(passwordLength) {
...
function finalSelection(userSelects, passwordLength, myPassword) {
  var myPassword = [];

  for (var i = 0; i < passwordLength; i++) {
    myPassword = userSelects[Math.floor(Math.random() * userSelects.length)];
